...
def getOT(Graphs, Graphs2=None, Features= None, i_instatiations=100, k_colors=10, d_depth=5, D_dimensions=None, n_graphs_per_class=1, x=None,plot=False, regul=0, unbalanced=False, normalized=True, row_normalized=True, sort=True, distance='w', covariance='tied', alpha=1., num_workers=8, embedding_method='ccb',embedding_only=False,scale_multiple_costs="mean_dist"):
