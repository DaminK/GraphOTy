...
class LayeredNetworkGraph(object):
    ...
    def __init__(self, graphs, node_labels=None, layout=nx.spring_layout, ax=None, scale_size=True):
    ...
    def draw(self):
        ...
        self.draw_edges(self.edges_between_layers, color='k', alpha=0.4, linestyle=':', linewidth=1,zorder=2)
...
def plot_multiplex(G, node_labels=None):
    #
    #ax = fig.add_subplot(111, projection='3d')
    LayeredNetworkGraph(G, node_labels={g:g for g in G[0]} if node_labels is None else node_labels, layout=nx.spring_layout)
...
def plot_attributes_and_structure(A,S):
    ...
    plot_attributes(A,ax_A)

    plt.show()


def plot_attributes(A,ax=None):
